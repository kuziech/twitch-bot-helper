...
```bash
git clone https://github.com/kuzieno/twitch-bot-helper
cd twitch-bot-helper
```
...
4. Заполните `.env` своими токенами и настройками:
```env
...
- `!песня` - показывает текущий трек из Яндекс.Музыки
- `!клип` - создает 30-секундный клип
- `!тг` - напоминание о подписки
- `!плип` - пысалание нах*й =)

## Структура проекта

```
twitch-bot-yandex-music
